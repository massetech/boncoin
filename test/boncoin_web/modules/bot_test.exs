defmodule BoncoinWeb.BotTest do
  ...
  describe "bot algorythm scope link_phone for new user" do
    ...
    test "ask phone again", %{conn: conn} do
      conversation = insert(:conversation, %{scope: "link_phone_2", psid: "viber_2"})
  ...
  #     %{scope: scope, language: language, messages: messages} = %{scope: "offer_treated", user: user, announce: announce, bot: %{bot_provider: "viber", bot_id: nil, bot_user_name: nil, user_msg: nil}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  ...
  #     user = insert(:user)
  #     %{scope: scope, language: language, messages: messages} = %{scope: "", user: user, announce: nil, bot: %{bot_provider: "viber", bot_id: nil, bot_user_name: nil, user_msg: "*123#"}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  ...
  #     user = insert(:user)
  #     %{scope: scope, language: language, messages: messages} = %{scope: "", user: user, announce: nil, bot: %{bot_provider: "viber", bot_id: nil, bot_user_name: nil, user_msg: "*111#"}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  ...
  #     user = insert(:user)
  #     %{scope: scope, language: language, messages: messages} = %{scope: "", user: user, announce: nil, bot: %{bot_provider: "viber", bot_id: nil, bot_user_name: nil, user_msg: "*888#"}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  ...
  #     %{scope: scope, language: language, messages: messages} = %{scope: "update_phone", user: user, announce: nil, bot: %{bot_provider: "viber", bot_id: nil, bot_user_name: nil, user_msg: user.phone_number}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  ...
  #     user = insert(:user, %{phone_number: "09030303030"})
  #     %{scope: scope, language: language, messages: messages} = %{scope: "update_phone", user: user, announce: nil, bot: %{bot_provider: "viber", bot_id: nil, bot_user_name: nil, user_msg: "09030303032"}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  ...
  #     user = insert(:user)
  #     %{scope: scope, language: language, messages: messages} = %{scope: "update_phone", user: user, announce: nil, bot: %{bot_provider: "viber", bot_id: nil, bot_user_name: nil, user_msg: "0902020202029282"}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  ...
  #     other_user = insert(:user, %{bot_active: true, bot_id: "123", phone_number: "09010101010"})
  #     %{scope: scope, language: language, messages: messages} = %{scope: "update_phone", user: user, announce: nil, bot: %{bot_provider: "viber", bot_id: nil, bot_user_name: "viber_name", user_msg: "09010101010"}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  #     assert msg =~ "this phone number is used by another user"
  #   end
  ...
  #     %{scope: scope, language: language, messages: messages} = %{scope: "update_phone", user: user, announce: nil, bot: %{bot_provider: "viber", bot_id: "12345", bot_user_name: "viber_name", user_msg: "09010101019"}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  #     assert msg =~ "your phone number was updated"
  #   end
  ...
  #     user = insert(:user)
  #     %{scope: scope, language: language, messages: messages} = %{scope: "", user: user, announce: nil, bot: %{bot_provider: "viber", bot_id: nil, bot_user_name: nil, user_msg: "*999#"}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  ...
  #     user = insert(:user)
  #     %{scope: scope, language: language, messages: messages} = %{scope: "quit_bot", user: user, announce: nil, bot: %{bot_provider: "viber", bot_id: nil, bot_user_name: nil, user_msg: "1"}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  ...
  #     user = insert(:user)
  #     %{scope: scope, language: language, messages: messages} = %{scope: "quit_bot", user: user, announce: nil, bot: %{bot_provider: "viber", bot_id: nil, bot_user_name: nil, user_msg: "other thing"}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  ...
  #     %{scope: scope, language: language, messages: messages} = %{scope: "quit_bot", user: user, announce: nil, bot: %{bot_provider: "viber", bot_id: nil, bot_user_name: nil, user_msg: "*999#"}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  #     assert msg =~ "account because you still have 3 active offers"
  #   end
  ...
  #     user = insert(:user)
  #     %{scope: scope, language: language, messages: messages} = %{scope: "", user: user, announce: nil, bot: %{bot_provider: "viber", bot_id: nil, bot_user_name: nil, user_msg: "0"}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  ...
  #     user = insert(:user)
  #     %{scope: scope, language: language, messages: messages} = %{scope: "", user: user, announce: nil, bot: %{bot_provider: "viber", bot_id: nil, bot_user_name: nil, user_msg: "whatever anything"}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  #     assert msg =~ "Please visit us on"
  #   end
  ...
  #     %{scope: scope, language: language, messages: messages} = %{scope: "", user: nil, announce: nil, bot: %{bot_provider: "viber", bot_id: nil, bot_user_name: nil, user_msg: "whatever anything"}}
  #       |> call_bot_algorythm()
  #     msg = List.first(messages)
  #     assert msg =~ "Welcome to Pawchaungkaung, please choose your language"
  #   end
