...
//   new_card.alert_date = new Date().toISOString()
...
//   card.alert_date = new_card.alert_date
//   card.updated = true
//   card.last_update = new Date().toISOString()
//   console.log(card.last_update)
...
//   check_need_for_server_update()
// }
//
// let check_need_for_server_update = () => {
//   var nb_change = window.everlearn.nb_change
//   window.everlearn.nb_change = nb_change + 1
//   if (navigator.onLine == true && nb_change > 10 && window.everlearn.updating == false) {
//     call_everlearn_api()
//   }
